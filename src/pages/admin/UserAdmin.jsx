...
const MemberList = () => {
    ...
    const fetchMemberData = async () => {
        try {
            const response = await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/v1/admin/userList`, {
                method: 'GET',
                headers: {
    ...
    const handleRestoreMember = async (username) => {
        try {
            const response = await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/v1/restoreUser/${username}`, {
