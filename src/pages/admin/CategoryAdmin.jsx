...
const CategoryListAdmin = () => {
    ...
    const handleAddCategory = (categoryName) => {
        fetch(`${process.env.REACT_APP_API_BASE_URL}/admin/category/post`, {
            method: 'POST',
            headers: {
    ...
    const handleUpdateCategory = (categoryName) => {
        fetch(`${process.env.REACT_APP_API_BASE_URL}/admin/category/edit/${categoryToEdit.id}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                Authorization: `${localStorage.getItem('token')}`,
    ...
    const handleDeleteCategory = () => {
        fetch(`${process.env.REACT_APP_API_BASE_URL}/admin/category/delete/${deleteCategoryId}`, {
            method: 'DELETE',
            headers: {
                Authorization: `${localStorage.getItem('token')}`,
            },
