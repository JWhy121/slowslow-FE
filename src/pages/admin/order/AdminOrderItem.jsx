...
function AdminOrderItem({
    ...
    const handleChange = async (event) => {
        ...
        const url = `${process.env.REACT_APP_API_BASE_URL}/admin/orders/${orderId}?status=${event.target.value}`;
        try {
    ...
    const orderDeleteHandler = async () => {
        ...
        const url = `${process.env.REACT_APP_API_BASE_URL}/admin/orders/${orderId}`;
        try {
            const response = await fetch(url, {
                method: 'DELETE',
                headers: {
